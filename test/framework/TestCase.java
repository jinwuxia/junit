...
public abstract class TestCase {
     ...
     */
	protected void myassert(boolean condition) {
		if (!condition) {
     ...
     */
	protected void myassert(String message, boolean condition) {
		if (!condition) {
	...
	protected void assertEquals(Object expected, Object actual) {
	    if (!expected.equals(actual)){
    		myassert(notEqualsMessage("", expected, actual), false);
	    }
	}
	...
	protected void assertEquals(long expected, long actual) {
	    if (expected != actual) {
			myassert (notEqualsMessage("", new Long(expected), new Long(actual)),false);
		}
	}
	...
	protected void assertEquals(double expected, double actual, double delta) {
	    if (Math.abs(expected-actual) > delta) {
			myassert (notEqualsMessage("", new Double(expected), new Double(actual)),false);
		}
	}
    ...
    protected void assertEquals(String message, Object expected, Object actual) {
        if (!expected.equals(actual)) {
			myassert (notEqualsMessage(message + " ", expected, actual),false);
		}
    }
    ...
    protected void assertEquals(String message, long expected, long actual) {
	    if (expected != actual) {
			myassert (notEqualsMessage(message + " ", new Long(expected), new Long(actual)),false);
		}
    }
	...
	protected void assertEquals(String message, double expected, double actual, double delta) {
	    if (Math.abs(expected-actual) > delta) {
			myassert (notEqualsMessage(message + " ", new Double(expected), new Double(actual)),false);
		}
    }
