 ...
 * the tests to be run.
 * <pre>
 * Synopsis: java java.ui.UnitTest [TestCase]
 * </pre>
 * UnitTest takes as an optional argument the name of the testcase
 * class to be run.
 *
 */

public class UniTestGui extends java.awt.Frame implements java.awt.event.ActionListener, java.awt.event.ItemListener, java.awt.event.MouseListener, java.awt.event.TextListener, java.awt.event.WindowListener, java.lang.Runnable {
	...
	private ProgressBar ivjStatusIndicator = null;
 ...
 */
public UniTestGui(String title) {
	super(title);
}
/**
...
/**
 * conn0:  (UnitTest.window.windowClosing(java.awt.event.WindowEvent) --> UnitTest.dispose())
...
/**
 * conn1:  (run.action.actionPerformed(java.awt.event.ActionEvent) --> UnitTest.runSuite()V)
...
/**
 * conn2:  (SuiteField.text.textValueChanged(java.awt.event.TextEvent) --> UnitTest.suiteNameChanged()V)
...
/**
 * conn3:  (ShowErrorButton.action.actionPerformed(java.awt.event.ActionEvent) --> UnitTest.showErrorTrace()V)
 * @param arg1 java.awt.event.ActionEvent
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
...
/**
 * conn4:  (FailureList.item.itemStateChanged(java.awt.event.ItemEvent) --> UnitTest.listSelectionChanged()V)
 * @param arg1 java.awt.event.ItemEvent
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
...
/**
 * conn5:  (FailureList.mouse.mouseClicked(java.awt.event.MouseEvent) --> UnitTest.showErrorTrace()V)
...
/**
 * conn6:  (SuiteField.action.actionPerformed(java.awt.event.ActionEvent) --> UnitTest.runSuite()V)
 * @param arg1 java.awt.event.ActionEvent
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
...
/**
 * conn7:  (QuitButton.action.actionPerformed(java.awt.event.ActionEvent) --> UnitTest.quit()V)
 * @param arg1 java.awt.event.ActionEvent
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
...
/**
 * conn8:  (Logo1.mouse.mouseClicked(java.awt.event.MouseEvent) --> UnitTest.about()V)
 * @param arg1 java.awt.event.MouseEvent
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
 ...
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
private ProgressBar getStatusIndicator() {
	if (ivjStatusIndicator == null) {
		try {
			ivjStatusIndicator = new ProgressBar();
...
public static void main(java.lang.String[] args) {
	try {
		UniTestGui aTestRunner = new UniTestGui();
		try {
...
public void run ( ) {
	...
	fTestResult= new GUITestResult(this);
