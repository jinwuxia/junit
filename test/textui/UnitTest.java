 ...
 * UnitTest expects as its only argument the name of a class with a <code>suite</code>
 * method. The suite method should return a test to be run.
 * UnitTest prints out a trace as the tests are executed followed by a
 * summary at the end.
 * Here is the synopsis:
 * <pre>
 *  java test.testui.UnitTest [-wait] VectorTest
 * </pre>
 */
public class UnitTest {
     ...
     *     test.textui.UnitTest.run(suite());
     * }
     * </pre>
     */
